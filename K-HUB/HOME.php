        ...
        <tr>
            <td>
                ...
                <div class="additional-container">
                    ...
                    <br /><br />
                    <a style="display: inline-block; width: 100px; height: 60px; color: white; background-color: rgb(132,132,132); 
            border: none; border-radius: 20px; text-decoration: none; display: flex; justify-content: center; 
            align-items: center; transition: background-color 0.3s ease;" 
            href="istorie.php" 
            onmouseover="this.style.backgroundColor='darkred'" 
            onmouseout="this.style.backgroundColor='black'">  MORE  </a>
<br /><br /><br /><br /><br />
                </div>
