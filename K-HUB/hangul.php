...
$conn = new mysqli($host, $usernameDB, $passwordDB, $dbname);
        ...
        foreach ($answers as $question => $correctAnswer) {
            $selectedValue = $_POST[$question] ?? ''; 
            if ($selectedValue == $correctAnswer) {
                $score++;
            }
        }

        $updateQuery = "UPDATE users SET quiz_score = ? WHERE id = ?";
...
function submitQuiz() {
    ...
    scoreDisplay.innerHTML = `<h2 style="color:darkred">Your score is: ${score}/5</h2>`;
...
<body>
    ...
    <div class="bd">
        ...
        <div class="additional-container2">
            ...
            <p>Videoclipuri ajutatoare: <br />
            <a href="https://youtu.be/SzAb6wGpv9c?si=GqtLGcazlTFA9csF" target="_blank">Exerseaza cititul</a><br />
            <a href="https://youtu.be/7QXlNdIpsmc?si=NslnJYmI1lOWgxMW" target="_blank">Exerseaza silabe</a><br />
            <a href="https://youtu.be/JUWgP5gNiHk?si=zWDDyD8HWhWzQSBz" target="_blank">Dictare</a></p>
        </div>
        <div class="additional-container2">
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            <div class="question">
                <p>What is the Korean character for 'k'?</p>
                <label>
                    <input type="radio" name="question1" value="k"> ㄱ
                </label>
                <label>
                    <input type="radio" name="question1" value="n"> ㄴ
                </label>
                <label>
                    <input type="radio" name="question1" value="d"> ㄷ
                </label>
            </div>
        <div class="question">
            <p>What is the Korean character for 'r/l'?</p>
            <label>
                <input type="radio" name="question2" value="r/l"> ㄹ
            </label>
            <label>
                <input type="radio" name="question2" value="m"> ㅁ
            </label>
            <label>
                <input type="radio" name="question2" value="b"> ㅂ
            </label>
        </div>

        <div class="question">
            <p>What is the Korean character for 'ch'?</p>
            <label>
                <input type="radio" name="question3" value="ng/consoana muta"> ㅇ
            </label>
            <label>
                <input type="radio" name="question3" value="ci"> ㅊ
            </label>
            <label>
                <input type="radio" name="question3" value="t"> ㅌ
            </label>
        </div>

        <div class="question">
            <p>What is the Korean character for 's'?</p>
            <label>
                <input type="radio" name="question4" value="s"> ㅅ
            </label>
            <label>
                <input type="radio" name="question4" value="h"> ㅎ
            </label>
            <label>
                <input type="radio" name="question4" value="p"> ㅍ
            </label>
        </div>

        <div class="question">
            <p>What is the difference between ㄱ and ㄲ?</p>
            <label>
                <input type="radio" name="question5" value="kk"> They are the same.
            </label>
            <label>
                <input type="radio" name="question5" value="pp"> ㄱ is softer than ㄲ.
            </label>
            <label>
                <input type="radio" name="question5" value="dd"> ㄱ is louder than ㄲ.
            </label>
        </div>
